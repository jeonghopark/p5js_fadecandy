...
OPC.prototype.drawFrame = function() {
	...
	for (let led = 0; led < leds; led++) {
		let i = led;
		packet[dest++] = pixels[this.pixelLocationsRed[i]] * _brightness;
		packet[dest++] = pixels[this.pixelLocationsGre[i]] * _brightness;
		packet[dest++] = pixels[this.pixelLocationsBlu[i]] * _brightness;
	}
